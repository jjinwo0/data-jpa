...
class MemberRepositoryTest {
    ...
    public void testMember(){
        ...
        Member savedMember = memberRepository.save(member);//상속받은 JpaRepository 인터페이스에서 제공

        //get(): Optional<>을 따와서 사용할 수 있음. (Null 가능성 내포)
    ...
    public void returnType(){
        ...
        System.out.println("findMember: " + ccc);
    }
...
//        Page<Member> page = memberRepository.findTop3Age(age);

        Page<MemberDto> toMap = page.map(member -> new MemberDto(member.getId(), member.getUsername(), null));

        //then
        List<Member> content = page.getContent();
        long totalElements = page.getTotalElements(); //Page<>
